...
export default function AboutUs() {
  ...
  return (
    <div className='resume'>
        <h1>Misión</h1>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolores vel ad at, veniam voluptates expedita? Necessitatibus incidunt dolorem, nihil fugiat quod laudantium quia harum nostrum assumenda sequi veniam deleniti delectus.
        Maxime nostrum veritatis ex optio animi quas et consequatur nam sint dicta velit asperiores, voluptatibus ea inventore iure qui, voluptates recusandae amet nihil eaque! Perspiciatis natus quibusdam earum similique repellendus?
